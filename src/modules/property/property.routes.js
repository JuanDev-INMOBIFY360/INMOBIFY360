...
router.post("/", authMiddleware, authorize("property", "CREATE"), upload.array('imagenes'), createPropertyController);
router.put("/:id", authMiddleware, authorize("property", "UPDATE"), upload.array('imagenes'), updatePropertyController);
